function AboutPage(props) {
    return (        
        <div className="w-3/4 mx-auto flex flex-col items-center p-20">
        <div className="flex flex-col mb-20 gap-5">
            <h2 className="text-5xl mb-5 text-center">Overview</h2>
        ...
        <div className="flex flex-col mb-20">
            <h2 className="text-5xl mb-10 text-center">Features</h2>
